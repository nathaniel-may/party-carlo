...
resultCircle result = case _ of
    P90 ->  HH.div [ css "resultCircle",  HP.id "p90"]  [ HH.span_ [ HH.text $ displayRange result.p90 ] ]
    P95 ->  HH.div [ css "resultCircle",  HP.id "p95"]  [ HH.span_ [ HH.text $ displayRange result.p95 ] ]
    P99 ->  HH.div [ css "resultCircle",  HP.id "p99"]  [ HH.span_ [ HH.text $ displayRange result.p99 ] ]
    P999 -> HH.div [ css "resultCircle",  HP.id "p999"] [ HH.span_ [ HH.text $ displayRange result.p999 ] ]
